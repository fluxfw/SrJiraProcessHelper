...
```php
use srag\DIC\SrJiraProcessHelper\x\DICStatic;use srag\Plugins\x\x\x;DICStatic::dic()->database()->createAutoIncrement(x::TABLE_NAME, "id");
```
...
```php
...
use srag\DIC\SrJiraProcessHelper\x\Version\PluginVersionParameter;
...
