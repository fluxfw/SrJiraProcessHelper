...
```php
\srag\DIC\SrJiraProcessHelper\x\DICStatic::dic()->database()->createAutoIncrement(\srag\Plugins\x\x\x::TABLE_NAME, "id");
```
...
```php
...
use srag\DIC\SrJiraProcessHelper\x\DevTools\DevToolsCtrl;
...
    /**
     * @inheritDoc
     */
...
/**
 * ...
 * @ilCtrl_isCalledBy srag\DIC\SrJiraProcessHelper\x\DevTools\DevToolsCtrl: ilXConfigGUI
 */
class ...
...
    /**
