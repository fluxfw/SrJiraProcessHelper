...
```json
  "pre-autoload-dump": [
    ...,
      "srag\\GeneratePluginInfosHelper\\SrJiraProcessHelper\\x\\GeneratePluginPhpAndXml::generatePluginPhpAndXml"
    ]
```
...
```json
  "pre-autoload-dump": [
    ...,
     "srag\\GeneratePluginInfosHelper\\SrJiraProcessHelper\\x\\GeneratePluginReadme::generatePluginReadme"
    ]
```
...
```json
  "pre-autoload-dump": [
    ...,
     "srag\\GeneratePluginInfosHelper\\SrJiraProcessHelper\\x\\UpdatePluginReadme::updatePluginReadme"
    ]
```
