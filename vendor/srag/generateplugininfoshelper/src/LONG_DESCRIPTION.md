...
```php
...
use srag\GeneratePluginInfosHelper\SrJiraProcessHelper\x\GeneratePluginPhpAndXml; 
...
...
```php
...
use srag\GeneratePluginInfosHelper\SrJiraProcessHelper\x\GeneratePluginReadme; 
...
...
```json
  ...
  "update-version": [
    ...,
     "srag\\GeneratePluginInfosHelper\\SrJiraProcessHelper\\x\\UpdateVersion::updateVersion"
    ]
  ...
```
...
```php
...
use srag\GeneratePluginInfosHelper\SrJiraProcessHelper\x\UpdateVersion; 
...
